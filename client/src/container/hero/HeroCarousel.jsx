...
import { background6, background4, background5, BgSkyland1, BgSkyland2, BgSkyland3 } from "../../assets/img";
...
const HeroCarousel = ({ id }) => {
  ...
  const slides = [
    { name: "slide1", image: BgSkyland1, content: SlideContent1 },
    { name: "slide2", image: BgSkyland2, content: SlideContent2 },
    { name: "slide3", image: BgSkyland3, content: SlideContent3 }
  ]
